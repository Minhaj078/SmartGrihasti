...
//       >
//         <div className="flex flex-col gap-5 m-auto items-start p-8 py-12 min-w-80 sm:min-w-88 rounded-lg border border-gray-200">
...
const SellerLogin = () => {
  ...
  return (
    !isSeller && (
      <form
        onSubmit={onSubmitHandler}
        className="min-h-screen flex items-center justify-end text-sm text-gray-600 pb-16"
        //                                              ^^^^^^^^^^ ^^^^^^
        // Added justify-end to push content to the bottom
        // Added pb-16 for some padding at the bottom (adjust as needed)
      >
        <div className="flex flex-col gap-5 m-auto items-start p-8 py-12 min-w-80 sm:min-w-88 rounded-lg border border-gray-200">
          <p className="text-2xl font-medium m-auto">
            <span className="text-primary">Seller</span>Login

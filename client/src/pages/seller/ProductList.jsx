...
const ProductList = () => {
  ...
  try {
    ...
    if (data.success) {
      fetchProducts(); // make sure this function exists or is passed from context
      toast.success(data.message); // ✅ this shows green tick
    } else {
      toast.error(data.message); // ❌ only for actual failure
    }
  } catch (error) {
